        ...
        while (true) {
            ...
            switch (subOpcao) {
                case 1:
                    ...
                    sca.nextLine();
                    executarUpdate("UPDATE pedido SET id_clientes = ? WHERE id_pedido = ?", novoCli, idPedido, "Cliente updated!");
                    break;
                ...
                case 2:
                    ...
                    if (opc.equalsIgnoreCase("s")) {
                        ...
                        executarUpdateDouble("UPDATE pedido SET valor_total = ? WHERE id_pedido = ?", novoValorTotal, idPedido, "Produtos e valor total atualizados!");
                    }
                    break;
